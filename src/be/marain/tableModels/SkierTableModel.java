...
public class SkierTableModel extends AbstractTableModel{
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		switch (columnIndex) {
	        case 0: return skier.getPersonId();
	        case 1: return skier.getName();
	        case 2: return skier.getSurname();
	        case 3: return skier.getDateOfBirth();
	        case 4: return skier.getPhoneNumber();
	        default: return null;
		}
	}
